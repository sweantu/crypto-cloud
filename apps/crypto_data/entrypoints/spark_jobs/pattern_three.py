...
if __name__ == "__main__":
    from spark_jobs.transformation.patterns.pattern_three import transform_pattern_three

    transform_pattern_three(
        spark=spark,
        symbol=symbol,
    ...
    logger.info("✅Transform pattern three completed successfully.")
