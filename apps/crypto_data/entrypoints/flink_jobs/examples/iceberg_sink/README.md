...
- Avoid Compatibility Issues - If you include JAR dependencies compiled for Java 21/22 you may face errors like _java.lang.UnsupportedClassVersionError: Unsupported major.minor version 65_
...
3. Set the environment variable `RUN_LOCAL=true`. You can do from the prompt or in the run profile of the IDE
4. Run `main.py`
